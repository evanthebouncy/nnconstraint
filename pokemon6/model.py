...
W_conv1 = weight_variable([15, 15, 5, 4])
...
for i in range(5000001):
  ...
  if (i % 10 == 0):
    ...
    draw(out_pred[0], "./drawings/{0}_run_pred.png".format(i/10))
    draw(z_loc[0], "./drawings/{0}_run_truth.png".format(i/10))
    draw_obs([k_loc[0] for k_loc in k_locs], "./drawings/{0}_run_obs.png".format(i/10))
